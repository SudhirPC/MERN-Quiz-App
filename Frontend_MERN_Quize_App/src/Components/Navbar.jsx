...
export const Navbar = () => {
  ...
  <div className="w-2/5 py-2 mx-36">
      ...
      <div className="w-3/12 flex justify-around py-4">
        ...
        <div className="flex">
          <h1  to="/cart" className="font-medium mr-2">ACCOUNT</h1>
