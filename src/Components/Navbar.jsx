...
export const Navbar = () => {
  ...
  return (
    <div className="w-11/12 h-16 m-auto flex bg-slate-100">
      ...
      <div className="w-1/4 flex justify-around py-4 ml-24">
  ...
  <div className="w-2/5 py-2">
        <div className="flex h-10 py-2 mt-1 bg-gray-200">
          <div className="w-3/4 ">
            <input
              className="w-3/4 pl-10 bg-gray-200 focus:outline-none"
              type="text"
              placeholder="What are you looking for?"
            />
          </div>
          <div className="py-1 ml-10 px-3">
            <svg
      ...
      <div className="w-3/12 flex justify-around py-4">
        ...
        <div className="flex">
          <Link  to="/cart" className="font-medium mr-2">ACCOUNT</Link>
